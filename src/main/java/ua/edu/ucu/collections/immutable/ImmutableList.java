...
public interface ImmutableList {
    ...
    // колекції за індексом,та кидає виключну ситуацію, якщо
    ...
    Object get(int index); //повертає елемент за індексом, та
    // кидає виключну ситуацію, якщо індекс виходить за межі
    // колекції
